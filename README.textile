...
h2. "Slice and dice subtitle files, and link them to extracted clips"

We want to be able to click on a rendered view of a subtitle file, and go directly to the part of the .avi file in question. 
